...
import { Building, Flat, Ticket, WorkOrder, Person, PaymentFrequency, WorkOrderStatus, WorkOrderPriority, UrgencyLevel, TicketStatus, AssetCategory, AssetStatus, PersonStatus } from '../types'
...
export const mockWorkOrders: WorkOrder[] = [
  {
    ...
    createdByUid: 'manager-2',
    createdByUserEmail: 'manager@victoriaheights.co.uk',
    flatId: undefined,
    scheduledDate: new Date('2024-03-11T08:00:00Z'),
    assignedToUid: 'contractor-1',
    assignedToUserEmail: 'contractor1@email.com',
    createdAt: new Date('2024-03-08T09:00:00Z'),
  ...
  },
  {
    ...
    createdByUid: 'manager-1',
    createdByUserEmail: 'manager@riversidegardens.co.uk',
    flatId: 'flat-3',
    scheduledDate: new Date('2024-03-13T09:00:00Z'),
    assignedToUid: 'contractor-3',
    assignedToUserEmail: 'contractor3@email.com',
  ...
  },
  {
    ...
    createdByUid: 'manager-3',
    createdByUserEmail: 'manager@canarywharftowers.co.uk',
    flatId: undefined,
    scheduledDate: new Date('2024-03-06T10:00:00Z'),
    assignedToUid: 'contractor-2',
    assignedToUserEmail: 'contractor2@email.com',
    ...
    managerCommunication: [],
    userFeedbackLog: [{
      message: 'Excellent service, treadmill working perfectly now',
      timestamp: new Date('2024-03-07T09:00:00Z'),
      userId: 'resident-15',
...
export const mockBudgets = [
  {
    ...
    totalBudget: 85000,
    totalAmount: 85000,
    allocatedAmount: 75600,
    spentAmount: 65100,
    remainingAmount: 19900,
    categories: [
      {
        id: 'cat-1',
  ...
  },
  {
    ...
    totalBudget: 72000,
    totalAmount: 72000,
    allocatedAmount: 61200,
    spentAmount: 43200,
    remainingAmount: 28800,
    categories: [
      {
        id: 'cat-6',
        name: 'Service Charges',
  ...
  },
  {
    ...
    totalBudget: 125000,
    totalAmount: 125000,
    allocatedAmount: 107100,
    spentAmount: 84150,
    remainingAmount: 40850,
    categories: [
      {
        id: 'cat-10',
        name: 'Service Charges',
        ...
        budgetAmount: 91800,
        actualAmount: 68850,
        allocatedAmount: 91800,
        spentAmount: 68850,
        remainingAmount: 22950,
        description: 'Quarterly service charges'
      },
      {
        id: 'cat-11',
